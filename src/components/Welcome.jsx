...
const Welcome = () => {
    ...
    return (
        <section id="welcome">
            <p ref={subtitleRef} >{renderText("Hey, I'm Omkar! Welcome to my", "font-3xl font-georama", 100)}</p>
            <h1 ref={titleRef} className="mt-6" >{renderText("portfolio", "text-9xl italic font-georama")}</h1>
